...
for imageIndex in range(len(data_list.index)):
    ...
    imageDict = {imageIndex: blocksFeatureVector}
    featureVectorDataFrame.insert(imageIndex, imageIndex, imageDict[imageIndex])

# writing results into an excel file
featureVectorDataFrame.to_csv("feature-vectors.csv", index=False)
